...
sim <- function(x, scen) {
  ...
  la <- c(rep("Continuous", floor(d / 2)), rep("Ordinal", d - floor(d / 2)))
...
write.csv(aaa, file="result_M2_200_2187_0.01_0.5_1234.csv")
...
round(out, 3)
write.csv(out, file="summary_M2_200_2187_0.01_0.5_1234.csv")
